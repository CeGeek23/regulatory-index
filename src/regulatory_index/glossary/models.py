...
# Catégorie d'un terme défini. `actor` regroupe toute personne/entité régulée ou qui agit ;
# le reste décrit des objets/concepts. None = non classé (à trier, comme un « vocab gap »).
TermType = str
...
class DefinedTerm(BaseModel):
    ...
    type: TermType | None = Field(default=None, description="actor | fund | concept | ...")
    term_en: str
    term_fr: str
